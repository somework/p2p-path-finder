...
final class PathSearchEngineHeuristicsTest extends TestCase
{
    ...
    public function test_record_state_replaces_inferior_entries(): void
    {
        ...
        $signatureMethod = new ReflectionMethod(PathSearchEngine::class, 'stateSignature');
    ...
    public function test_money_signature_formats_null_and_scaled_amounts(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'moneySignature');
    ...
    public function test_state_signature_normalizes_range_and_desired_amounts(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'stateSignature');
        $method->setAccessible(true);
    ...
    public function test_edge_supports_amount_rejects_positive_spend_when_edge_only_supports_zero(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'edgeSupportsAmount');
        $method->setAccessible(true);
    ...
    public function test_calculate_next_range_normalizes_descending_bounds(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'calculateNextRange');
        $method->setAccessible(true);
        ...
        $convertMethod = new ReflectionMethod(PathSearchEngine::class, 'convertEdgeAmount');
    ...
    public function test_convert_edge_amount_returns_zero_when_edge_cannot_convert(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'convertEdgeAmount');
        $method->setAccessible(true);
    ...
    public function test_edge_effective_conversion_rate_inverts_sell_edges(): void
    {
        ...
        $ratioMethod = new ReflectionMethod(PathSearchEngine::class, 'edgeBaseToQuoteRatio');
        $ratioMethod->setAccessible(true);
        $ratio = $ratioMethod->invoke($finder, $edge);

        $method = new ReflectionMethod(PathSearchEngine::class, 'edgeEffectiveConversionRate');
        $method->setAccessible(true);
    ...
    public function test_clamp_to_range_bounds_value(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'clampToRange');
        $method->setAccessible(true);
    ...
    public function test_normalize_tolerance_rejects_non_numeric_strings(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'normalizeTolerance');
        $method->setAccessible(true);
    ...
    public function test_calculate_tolerance_amplifier_returns_one_for_zero_tolerance(): void
    {
        ...
        $method = new ReflectionMethod(PathSearchEngine::class, 'calculateToleranceAmplifier');
        $method->setAccessible(true);
    ...
    {
        $finder = new PathSearchEngine(maxHops: 1, tolerance: '0.0', topK: 2);

        $createHeap = new ReflectionMethod(PathSearchEngine::class, 'createResultHeap');
        $createHeap->setAccessible(true);
        $heap = $createHeap->invoke($finder);

        $record = new ReflectionMethod(PathSearchEngine::class, 'recordResult');
    ...
    {
        $finder = new PathSearchEngine(maxHops: 1, tolerance: '0.0', topK: 3);
    ...
    {
        new PathSearchEngine(maxHops: 1, tolerance: '0.0');
    ...
    {
        $finder = new PathSearchEngine(maxHops: 2, tolerance: '0.0', topK: 4);
