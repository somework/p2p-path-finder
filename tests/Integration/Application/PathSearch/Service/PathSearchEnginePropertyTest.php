...
final class PathSearchEnginePropertyTest extends TestCase
{
    ...
    public function test_generated_graphs_produce_deterministic_unique_paths(): void
    {
        ...
        for ($iteration = 0; $iteration < $limit; ++$iteration) {
            ...
            $permutedFinder = new PathSearchEngine(
                maxHops: $scenario['maxHops'],
                tolerance: $scenario['tolerance'],
                topK: $scenario['topK'],
            );
            ...
            $scaledFinder = new PathSearchEngine(
