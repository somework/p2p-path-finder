...
final class PathSearchEngineOrderingDeterminismTest extends TestCase
{
    /**
     * @testdox Equal-cost paths with different hops are ordered deterministically
     */
    public function test_equal_cost_paths_order_deterministically(): void
    {
     ...
     */
    public function test_path_signature_ordering(): void
    {
     ...
     */
    public function test_repeated_runs_produce_same_order(): void
    {
     ...
     */
    public function test_ordering_determinism_across_multiple_currencies(): void
    {
     ...
     */
    public function test_multiple_paths_stable_ordering(): void
    {
        $orderBook = new OrderBook();
     ...
     */
    public function test_different_costs_order_by_cost_not_signature(): void
    {
        $orderBook = new OrderBook();
     ...
     */
    public function test_ordering_considers_hop_count(): void
    {
        $orderBook = new OrderBook();
        ...
        $hopCounts = array_map(static fn ($p) => $p->hops(), $paths);
