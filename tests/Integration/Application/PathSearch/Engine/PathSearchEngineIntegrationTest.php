...
/**
 * Integration tests for PathSearchEngine with real GraphBuilder and OrderFactory dependencies.
 *
 * These tests validate complex path finding scenarios using realistic order books
 * and graph structures, ensuring the engine works correctly in real-world conditions.
 */
#[CoversClass(PathSearchEngine::class)]
final class PathSearchEngineIntegrationTest extends TestCase
{
    ...
    public function test_it_finds_best_rub_to_idr_path_under_various_filters(
        ...
        $finder = new PathSearchEngine($maxHops, $tolerance);
    ...
    public function test_it_limits_results_to_requested_top_k(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.999', topK: 2);
        ...
        $finderWithBroaderLimit = new PathSearchEngine(maxHops: 4, tolerance: '0.999', topK: 3);
        $extendedResults = $finderWithBroaderLimit->findBestPaths($graph, 'RUB', 'IDR');
        $extendedPaths = self::extractPaths($extendedResults);
    ...
    public function test_it_preserves_discovery_order_for_equal_cost_candidates(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 3, tolerance: '0.0', topK: 2);
    ...
    public function test_it_returns_same_paths_when_order_book_is_permuted(): void
    {
        ...
        $permutedFinder = new PathSearchEngine(maxHops: 3, tolerance: '0.0', topK: 3);
    ...
    public function test_it_prunes_paths_that_exceed_updated_tolerance_threshold(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.5', topK: 3);
        $outcome = $finder->findBestPaths($graph, 'RUB', 'IDR');
        $paths = self::extractPaths($outcome);
    ...
    public function test_it_tightens_best_cost_and_blocks_looser_candidates(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.1', topK: 3);
        $evaluatedCandidates = [];
    ...
    public function test_it_continues_iterating_neighbors_after_tolerance_skip(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.9', topK: 2);
    ...
    public function test_it_preserves_best_cost_after_accepting_tolerated_candidate(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.9', topK: 3);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
        $paths = self::extractPaths($outcome);
    ...
    public function test_it_updates_best_cost_after_discovering_a_better_candidate(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 2, tolerance: '0.0', topK: 3);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
        $paths = self::extractPaths($outcome);
    ...
    public function test_it_continues_evaluating_edges_after_missing_neighbor(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 1, tolerance: '0.0', topK: 1);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
        $paths = self::extractPaths($outcome);
    ...
    public function test_it_continues_processing_queue_after_skipping_hop_limited_state(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 2, tolerance: '0.0', topK: 1);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
    ...
    public function test_it_respects_visited_state_guard_threshold(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 2, tolerance: '0.0', topK: 1, maxVisitedStates: 4);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
    ...
    public function test_it_keeps_processing_guarded_states_with_matching_signatures(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.0', topK: 2, maxVisitedStates: 5);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
    ...
    public function test_it_enforces_time_budget_guard_on_dense_graph(): void
    {
        ...
        $guardedFinder = new PathSearchEngine(
            maxHops: 6,
            tolerance: '0.0',
            topK: 1,
    ...
    public function test_it_enforces_expansion_guard_on_dense_graph(): void
    {
        ...
        $relaxedFinder = new PathSearchEngine(
            maxHops: 5,
            tolerance: '0.0',
            topK: 1,
            maxExpansions: 20000,
    ...
    public function test_it_does_not_accept_cycles_that_improve_conversion_costs(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.0', topK: 1);
        $outcome = $finder->findBestPaths($graph, 'SRC', 'TRG');
    ...
    public function test_it_normalizes_endpoint_case_inputs(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 3, tolerance: '0.0');
        $results = self::extractPaths($finder->findBestPaths($graph, 'rub', 'idr'));
    ...
    public function test_it_avoids_cycles_that_return_to_the_source(): void
    {
        ...
        $graph = (new GraphBuilder())->build($orders);
        $finder = new PathSearchEngine(maxHops: 4, tolerance: '0.0', topK: 4);

        $outcome = $finder->findBestPaths($graph, 'USD', 'JPY');
        $paths = self::extractPaths($outcome);
    ...
    public function test_it_continues_search_when_callback_rejects_initial_target_candidate(): void
    {
        ...
        self::assertSame(1, $firstCandidate->edges()->count());
        $firstEdges = $firstCandidate->edges()->toArray();
        self::assertSame('EUR', $firstEdges[0]['from']);
        self::assertSame('USD', $firstEdges[0]['to']);
    ...
    public function test_it_accounts_for_gross_base_when_scoring_buy_edges(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 1, tolerance: '0.0');
    ...
    public function test_it_accounts_for_combined_base_and_quote_fees_when_scoring_buy_edges(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 1, tolerance: '0.10');
        $results = self::extractPaths($finder->findBestPaths($graph, 'EUR', 'USD'));
    ...
    public function test_it_returns_zero_hop_path_when_source_equals_target(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 3, tolerance: '0.15');
    ...
    public function test_it_preserves_parallel_states_with_distinct_ranges(): void
    {
        ...
        $finder = new PathSearchEngine(maxHops: 2, tolerance: '0.0');
