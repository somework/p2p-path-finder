...
final class CostHopsSignatureOrderingStrategyTest extends TestCase
{
    ...
    {
        $cheaper = new PathOrderKey(new PathCost('0.100000000000000000'), 2, RouteSignature::fromNodes(['SRC', 'MID', 'DST']), 0);
        $expensive = new PathOrderKey(new PathCost('0.200000000000000000'), 1, RouteSignature::fromNodes(['SRC', 'ALT', 'DST']), 1);
    ...
    {
        $fewerHops = new PathOrderKey(new PathCost('0.150000000000000000'), 1, RouteSignature::fromNodes(['SRC', 'DST']), 2);
        $moreHops = new PathOrderKey(new PathCost('0.150000000000000000'), 3, RouteSignature::fromNodes(['SRC', 'MID', 'ALT', 'DST']), 3);
    ...
    {
        $alphaSignature = new PathOrderKey(new PathCost('0.175000000000000000'), 2, RouteSignature::fromNodes(['SRC', 'ALP', 'DST']), 4);
        $betaSignature = new PathOrderKey(new PathCost('0.175000000000000000'), 2, RouteSignature::fromNodes(['SRC', 'BET', 'DST']), 5);
    ...
    {
        $firstDiscovered = new PathOrderKey(new PathCost('0.300000000000000000'), 3, RouteSignature::fromNodes(['SRC', 'X', 'Y', 'DST']), 6);
        $secondDiscovered = new PathOrderKey(new PathCost('0.300000000000000000'), 3, RouteSignature::fromNodes(['SRC', 'X', 'Y', 'DST']), 7);
    ...
    {
        $key = new PathOrderKey(new PathCost('0.250000000000000000'), 2, RouteSignature::fromNodes(['SRC', 'MID', 'DST']), 8);
