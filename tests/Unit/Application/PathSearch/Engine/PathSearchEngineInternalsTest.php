...
final class PathSearchEngineInternalsTest extends TestCase
{
    ...
    public function test_initialize_search_structures_sets_expected_defaults(): void
    {
        ...
        self::assertInstanceOf(StatePriorityQueue::class, $queue);
        ...
        $unitValueProperty = new ReflectionProperty(PathSearchEngine::class, 'unitValue');
    ...
    {
        $finder = new PathSearchEngine(maxHops: 2, tolerance: '0.0', topK: 2);
    ...
    {
        $finder = new PathSearchEngine(maxHops: 3, tolerance: '0.0', topK: 1);
        /** @var CandidateResultHeap $heap */
        $heap = $this->invokeFinderMethod($finder, 'createResultHeap');
     ...
     */
    private function invokeFinderMethod(PathSearchEngine $finder, string $method, array $arguments = []): mixed
    {
        $reflection = new ReflectionMethod(PathSearchEngine::class, $method);
