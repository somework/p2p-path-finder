...
final class ToleranceAmplifierTest extends TestCase
{
    ...
    {
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: '0');
    ...
    {
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: $tolerance);
        $amplifier = $this->getToleranceAmplifier($pathFinder);
    ...
    public function test_tolerance_amplifier_with_medium_tolerance(): void
    {
        ...
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: '0.5');
        $amplifier = $this->getToleranceAmplifier($pathFinder);
    ...
    public function test_tolerance_amplifier_with_high_tolerance(): void
    {
        ...
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: '0.9');
        $amplifier = $this->getToleranceAmplifier($pathFinder);
    ...
    public function test_tolerance_amplifier_with_upper_bound_constraint(): void
    {
        ...
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: $maxTolerance);
        $amplifier = $this->getToleranceAmplifier($pathFinder);
    ...
    public function test_max_allowed_cost_with_amplifier(): void
    {
        ...
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: '0.2');
    ...
    {
        $pathFinder = new PathSearchEngine(maxHops: 2, tolerance: '0.1');
     ...
     */
    private function getToleranceAmplifier(PathSearchEngine $pathFinder): BigDecimal
    {
