...
namespace SomeWork\P2PPathFinder\Tests\Unit\Application;
...
final class SerializationContractTest extends TestCase
{
    ...
    {
        $paths = \SomeWork\P2PPathFinder\Application\PathSearch\Result\PathResultSet::fromPaths(
            new \SomeWork\P2PPathFinder\Application\PathSearch\Engine\Ordering\CostHopsSignatureOrderingStrategy(6),
            [],
            static fn ($p) => new \SomeWork\P2PPathFinder\Application\PathSearch\Engine\Ordering\PathOrderKey(
                new \SomeWork\P2PPathFinder\Application\PathSearch\Engine\Ordering\PathCost('0'),
                0,
                \SomeWork\P2PPathFinder\Application\PathSearch\Engine\Ordering\RouteSignature::fromNodes([]),
                0
            )
        );
    ...
    {
        $paths = \SomeWork\P2PPathFinder\Application\PathSearch\Result\PathResultSet::empty();
