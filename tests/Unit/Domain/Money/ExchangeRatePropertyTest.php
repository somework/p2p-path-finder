...
final class ExchangeRatePropertyTest extends TestCase
{
    ...
    public function test_exchange_rate_conversion_roundtrip(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $originalMoney = self::money($currencyA, $this->formatUnits($amountA, $scale), $scale);
    ...
    public function test_conversion_is_linear(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $moneyA1 = self::money($currencyA, $this->formatUnits($amountA1, $scale), $scale);
            $moneyA2 = self::money($currencyA, $this->formatUnits($amountA2, $scale), $scale);
    ...
    public function test_conversion_preserves_ordering(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $smaller = self::money($currencyA, $this->formatUnits($amount1, $scale), $scale);
            $larger = self::money($currencyA, $this->formatUnits($amount2, $scale), $scale);
    ...
    public function test_conversion_scales_with_multiplier(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $money = self::money($currencyA, $this->formatUnits($amount, $scale), $scale);
