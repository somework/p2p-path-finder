...
final class FeeBreakdownPropertyTest extends TestCase
{
    ...
    public function test_fees_are_never_negative(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $zeroBase = self::money($baseCurrency, '0', $scale);
            $zeroQuote = self::money($quoteCurrency, '0', $scale);
    ...
    public function test_has_fee_predicates_reflect_non_zero_amounts(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $zeroBaseFee = self::money($baseCurrency, '0', $scale);
            ...
            $zeroQuoteFee = self::money($quoteCurrency, '0', $scale);
    ...
    public function test_is_zero_reflects_absence_of_non_zero_fees(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $zeroFee = self::money($baseCurrency, '0', $scale);
            ...
            // Both zero -> is zero
            $bothZero = FeeBreakdown::of($zeroFee, self::money($quoteCurrency, '0', $scale));
    ...
    private function randomPositiveMoney(string $currency, int $scale): Money
    {
        ...
        return self::money($currency, $this->formatUnits($units, $scale), $scale);
    }
