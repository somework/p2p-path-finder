...
final class MoneyPropertyTest extends TestCase
{
    ...
    public function testMoneyAdditionIsCommutative(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $a = $this->money($currency, $this->formatUnits($amountA, $scale), $scale);
            $b = $this->money($currency, $this->formatUnits($amountB, $scale), $scale);
    ...
    public function testMoneyAdditionIsAssociative(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $a = $this->money($currency, $this->formatUnits($amountA, $scale), $scale);
            $b = $this->money($currency, $this->formatUnits($amountB, $scale), $scale);
            $c = $this->money($currency, $this->formatUnits($amountC, $scale), $scale);
    ...
    public function testZeroIsAdditiveIdentity(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $a = $this->money($currency, $this->formatUnits($amount, $scale), $scale);
    ...
    public function testScaleNormalizationPreservesEquality(): void
    {
        ...
        for ($i = 0; $i < $limit; ++$i) {
            ...
            $a = $this->money($currency, $this->formatUnits($amount, $scale1), $scale1);
