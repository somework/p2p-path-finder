...
### __construct
`PathCost::__construct(string $value)`
...
## SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchBootstrap

### Public methods

### __construct
`SearchBootstrap::__construct(SomeWork\P2PPathFinder\Application\PathFinder\SearchStateQueue $queue, SomeWork\P2PPathFinder\Application\PathFinder\CandidateResultHeap $results, SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateRegistry $registry, SomeWork\P2PPathFinder\Application\PathFinder\Search\InsertionOrderCounter $insertionOrder, SomeWork\P2PPathFinder\Application\PathFinder\Search\InsertionOrderCounter $resultInsertionOrder, int $visitedStates)`

### queue
`SearchBootstrap::queue(): SomeWork\P2PPathFinder\Application\PathFinder\SearchStateQueue`

### results
`SearchBootstrap::results(): SomeWork\P2PPathFinder\Application\PathFinder\CandidateResultHeap`

### registry
`SearchBootstrap::registry(): SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateRegistry`

### insertionOrder
`SearchBootstrap::insertionOrder(): SomeWork\P2PPathFinder\Application\PathFinder\Search\InsertionOrderCounter`

### resultInsertionOrder
`SearchBootstrap::resultInsertionOrder(): SomeWork\P2PPathFinder\Application\PathFinder\Search\InsertionOrderCounter`

### visitedStates
`SearchBootstrap::visitedStates(): int`

### __clone
`SearchBootstrap::__clone()`
...
### bootstrap
`SearchState::bootstrap(string $node, string $unitValue, ?SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\SpendRange $amountRange, ?SomeWork\P2PPathFinder\Domain\ValueObject\Money $desiredAmount): self`

Parameter $unitValue: numeric-string

### fromComponents
`SearchState::fromComponents(string $node, string $cost, string $product, int $hops, SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\PathEdgeSequence $path, ?SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\SpendRange $amountRange, ?SomeWork\P2PPathFinder\Domain\ValueObject\Money $desiredAmount, array $visited): self`

Parameter $cost: numeric-string
Parameter $product: numeric-string
Parameter $visited: array&lt;array-key, bool&gt;

Parameter $hops: int&lt;0, max&gt;

### transition
`SearchState::transition(string $nextNode, string $nextCost, string $nextProduct, SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\PathEdge $edge, ?SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\SpendRange $amountRange, ?SomeWork\P2PPathFinder\Domain\ValueObject\Money $desiredAmount): self`
...
### amountRange
`SearchState::amountRange(): ?SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\SpendRange`
...
### __construct
`SearchStatePriority::__construct(SomeWork\P2PPathFinder\Application\PathFinder\Result\Ordering\PathCost $cost, int $hops, SomeWork\P2PPathFinder\Application\PathFinder\Result\Ordering\RouteSignature $routeSignature, int $order)`

### cost
`SearchStatePriority::cost(): SomeWork\P2PPathFinder\Application\PathFinder\Result\Ordering\PathCost`

### hops
`SearchStatePriority::hops(): int`

### routeSignature
`SearchStatePriority::routeSignature(): SomeWork\P2PPathFinder\Application\PathFinder\Result\Ordering\RouteSignature`
...
### __construct
`SearchStateRecord::__construct(string $cost, int $hops, SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateSignature $signature)`
...
### signature
`SearchStateRecord::signature(): SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateSignature`
...
### isEmpty
`SearchStateRegistry::isEmpty(): bool`
...
### hasSignature
`SearchStateRegistry::hasSignature(string $node, SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateSignature $signature): bool`

### __clone
`SearchStateRegistry::__clone()`

## SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateSignature

### Public methods

### fromString
`SearchStateSignature::fromString(string $value): self`

### compose
`SearchStateSignature::compose(iterable $segments): self`

Parameter $segments: iterable&lt;string, string&gt;

### value
`SearchStateSignature::value(): string`

### equals
`SearchStateSignature::equals(self $other): bool`

### compare
`SearchStateSignature::compare(self $other): int`

### __toString
`SearchStateSignature::__toString(): string`

## SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateSignatureFormatter
Converts {@see SearchStateSignature} instances into associative maps for logging and debugging.

### Public methods

### format
`SearchStateSignatureFormatter::format(SomeWork\P2PPathFinder\Application\PathFinder\Search\SearchStateSignature|string $signature): array`

Returns: array&lt;string, string&gt;

## SomeWork\P2PPathFinder\Application\PathFinder\Search\SegmentPruner

### Public methods

### __construct
`SegmentPruner::__construct(string $measure)`

### prune
`SegmentPruner::prune(SomeWork\P2PPathFinder\Application\Graph\EdgeSegmentCollection $segments): SomeWork\P2PPathFinder\Application\Graph\EdgeSegmentCollection`
...
### at
`PathEdgeSequence::at(int $index): SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\PathEdge`

### has
`PathEdgeSequence::has(int $index): bool`
...
## SomeWork\P2PPathFinder\Application\PathFinder\ValueObject\SpendRange
Immutable representation of spend bounds propagated through the search graph.

### Public methods

### fromBounds
`SpendRange::fromBounds(SomeWork\P2PPathFinder\Domain\ValueObject\Money $min, SomeWork\P2PPathFinder\Domain\ValueObject\Money $max): self`

### fromArray
`SpendRange::fromArray(array $range): self`

Parameter $range: array{min: Money, max: Money}

### min
`SpendRange::min(): SomeWork\P2PPathFinder\Domain\ValueObject\Money`

### max
`SpendRange::max(): SomeWork\P2PPathFinder\Domain\ValueObject\Money`

### currency
`SpendRange::currency(): string`

### scale
`SpendRange::scale(): int`

### withScale
`SpendRange::withScale(int $scale): self`

### normalizeWith
`SpendRange::normalizeWith(SomeWork\P2PPathFinder\Domain\ValueObject\Money ...$values): self`

### clamp
`SpendRange::clamp(SomeWork\P2PPathFinder\Domain\ValueObject\Money $value): SomeWork\P2PPathFinder\Domain\ValueObject\Money`

### toBoundsArray
`SpendRange::toBoundsArray(): array`
