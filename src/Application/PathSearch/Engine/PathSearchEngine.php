...
final class PathSearchEngine
{
    ...
    private function createQueue(): StatePriorityQueue
    {
        return new StatePriorityQueue(self::SCALE);
    }
    ...
    {
        /** @var array<PathResultSetEntry<CandidatePath>> $entries */
    ...
    /**
     * @return array<PathResultSetEntry<CandidatePath>>
     */
    private function collectResultEntries(CandidateResultHeap $results): array
    {
        /** @var array<PathResultSetEntry<CandidatePath>> $collected */
        $collected = [];
        $clone = clone $results;
