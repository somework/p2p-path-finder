...
/**
 * Materializes graph edges into executable legs, resolving fees and balances.
 */
final class LegMaterializer
{
     ...
     * }|null
     */
    public function materializePath(array $edges, Money $requestedSpend, array $initialSeed, string $targetCurrency): ?array
    {
        $legs = [];
